    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView className="px-4 my-6">
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker('image')}>
            {form.thumbnail ? (
              ...
              <View className="w-full h-16 bg-black-100 px-4 rounded-2xl border-2 border-black-200 flex-row space-x-2 justify-center items-center">
                <Image
                  source={icons.upload}
                  className="w-5 h-5"
                  resizeMode="contain"
        ...
        <FormField
          title={'AI Prompt'}
          value={form.prompt}
          placeholder={'You used to create this video'}
